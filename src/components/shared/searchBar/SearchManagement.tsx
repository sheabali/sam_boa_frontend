...
const SearchManagement = () => {
  ...
  useEffect(() => {
    ...
    setBrand([
      ...
      { name: "American Eagle Outfitters", value: "american-eagle-outfitters" },
      { name: "Polo Ralph Lauren", value: "polo-ralph-lauren" },
      { name: "Gap", value: "gap" },
      { name: "Urban Outfitters", value: "urban-outfitters" },
      { name: "Topshop", value: "topshop" },
      ...
      { name: "Columbia Sportswear", value: "columbia-sportswear" },
      { name: "Champion", value: "champion" },
      { name: "ASOS", value: "asos" },
    ]);
