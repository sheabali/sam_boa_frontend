...
// Define form schema (removed unused availableSize field)
...
export default function CreateProductForm() {
  ...
  // Utility to convert File to base64 for console logging
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      // Convert images to base64 for logging (not for actual submission)
      const mainImageBase64 = mainImage ? await fileToBase64(mainImage) : null;
      const additionalImageBase64 = additionalImage
        ? await fileToBase64(additionalImage)
        : null;
      ...
      const formData = {
        ...
        mainImage: mainImageBase64
          ? { name: mainImage.name, data: mainImageBase64 }
          : null,
        additionalImage: additionalImageBase64
          ? { name: additionalImage?.name, data: additionalImageBase64 }
          : null,
      };
      ...
      // Simulate API call
      // await api.submitProduct(formData);
