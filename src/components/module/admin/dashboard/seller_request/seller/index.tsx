...
const fakeUser = {
  ...
  profileImage: "https://i.ibb.co/Rkp8d1qq/Rectangle-23854-1.png",
};
    ...
    <div className="container mx-auto px-4 py-8 md:px-6 lg:px-8">
        ...
        <div className="w-full border-2 border-dashed border-gray-300 rounded-xl py-12 px-4 flex flex-col items-center bg-gray-100">
          {imagePreview ? (
            <Image
              src={
                imagePreview ||
                "https://i.ibb.co/Rkp8d1qq/Rectangle-23854-1.png"
              }
              alt="Preview"
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex gap-4 justify-start">
          ...
          <Button
            variant="outline"
            className="text-muted-foreground px-8 border-primary text-primary hover:text-white"
